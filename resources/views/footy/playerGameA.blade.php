...
<li style="float:left; padding-left:5px; padding-top:5px;">
  ...
  Lineup</a></li>
  <li style="float:left"><a href="{{route('playIndex' , $usergame->game->team->id)}}" style = "display:block; color:white; text-align:center; padding:14px 16px; text-decoration:none ">
  Playbook</a></li>
  ...
  Statistics</a></li>
  <li style="float:left"><a href="{{route('quizIndex' , $usergame->game->team->id)}}" style = "display:block; color:white; text-align:center; padding:14px 16px; text-decoration:none ">
  Quizzes</a></li>
