...
<ul style="list-style-type: none;
  ...
  Calendar</a></li>
  <li style="float:left"><a href="{{route('roster' , $userseas->season->team->id)}}" style = "display:block; color:white; text-align:center; padding:14px 16px; text-decoration:none ">
  Lineup</a></li>
