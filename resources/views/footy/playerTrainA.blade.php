...
<li style="float:left; padding-left:5px; padding-top:5px;">
  ...
  Statistics</a></li>
  <li style="float:left"><a href="{{route('members' , $usertraining->game->team->id)}}" style = "display:block; color:white; text-align:center; padding:14px 16px; text-decoration:none ">
  Membership</a></li>
</ul>
...
<div class="container-fluid">
  ...
  <div class="row pt-1">
        ...
        <tbody style="height:50px;">
            <tr>
            <td>{{$usertraining->goals}}</td>
            <td>{{$usertraining->assists}}</td>
            <td>{{$usertraining->shots}}</td>
            <td>{{$usertraining->shotOT}}</td>
            <td>{{$usertraining->passes}}</td>
            <td>{{$usertraining->dribbles}}</td>
            <td>{{$usertraining->crosses}}</td>
            </tr>
    </table> 
		</div>
	</div>
  <div class="row">
        ...
        <tbody style="height:50px;">
            ...
            <td>{{$usertraining->headers}}</td>
            <td>{{$usertraining->clearances}}</td>
            <td>{{$usertraining->interceptions}}</td>
            <td>{{$usertraining->saves}}</td>
