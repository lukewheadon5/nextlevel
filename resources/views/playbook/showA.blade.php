...
<script src="{{ asset('js/playbookView.js') }}" defer></script>
...
<div class="container-fluid">
	<div class="row pt-3">
		<div class="col-md-2">
        <h2>
        <a href="{{route('playIndex' , $team->id)}}" tabindex="-1" role="button" ><i class="fa fa-arrow-circle-o-left" style="color:#000000" aria-hidden="true"></i></a>
		</h2>
        </div>
		<div class="col-md-8">
        <h1>
       {{$play->name}} 
		...
		<div class="col-md-2">
        <a href="{{ route('playDestroy', $play->id) }}" class="btn btn-danger" tabindex="-1" role="button" >Delete Play</a>
		</div>
	</div>
	<div class="row pt-3">
		<div class="col-md-2">
...
var json = <?php echo json_encode($play->canvas); ?>;
