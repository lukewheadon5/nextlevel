...
<div class="container-fluid">
    ...
    <a href="{{ route('quizCreate', $team->id) }}" class="btn btn-secondary" tabindex="-1" role="button" >Create Quiz</a>
    ...
    <div class="col-md-8">
      ...
      <table class="table table-sm table-striped text-center" id="myTable">
        ...
        <tbody>
          @foreach ($team->quizs as $quiz)
            <tr>
            <td>{{$quiz->name}}</td>
            <td><a href="{{ route('quizShow', $quiz->id) }}" class="btn btn-secondary" tabindex="-1" role="button" >View Quiz</a></td>
            <td><a href="{{ route('quizEdit', $quiz->id) }}" class="btn btn-secondary" tabindex="-1" role="button" >Edit Quiz</a></td>
            </tr>
          @endforeach
      </table>   
    </div>
